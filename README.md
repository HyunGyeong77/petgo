...
- 1️⃣ **Recommend Section 기능 구현 완료** │ 모바일, 데스크탑 반응형 및 Dropdown 메뉴 제작

- 2️⃣ **API 기반 데이터 패칭 및 화면 반영 완료** │ useQuery를 활용한 FastAPI GET 요청 처리 및 비동기 데이터 UI 렌더링 구현

<br><br>

**✅완료 (2/22)**

- 1️⃣ **Footer 구현 완료** | 모바일, 데스크탑 반응형 제작
